...
htmlhelp_basename = 'Transperthdoc'
...
latex_documents = [
    ('index', 'Transperth.tex', 'Transperth Documentation', 'Elliana May', 'manual'),
]
...
man_pages = [('index', 'transperth', 'Transperth Documentation', ['Elliana May'], 1)]
